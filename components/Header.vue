  ...
  methods: {
    networkClick(name) {
      ...
      if (name === Config.testnetChainId) {
        location.href = '//' + location.host.replace('www2.oasisscan.com', 'testnet2.oasisscan.com')
      } else {
        location.href = '//' + location.host.replace('testnet2.oasisscan.com', 'www2.oasisscan.com')
      }
